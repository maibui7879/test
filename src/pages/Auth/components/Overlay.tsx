    ...
    >
      {isLoginActive ? (
        <>
          ...
          <p className="mb-4 md:mb-6 px-3 md:px-0 text-sm md:text-base">Đăng ký ngay để trải nghiệm nhiều tính năng hấp dẫn!</p>
        ...
        <>
          ...
          <p className="mb-4 md:mb-6 px-3 md:px-0 text-sm md:text-base">Đăng nhập để tiếp tục sử dụng dịch vụ.</p>
          <button className="px-5 md:px-7 py-2 md:py-3 border border-white rounded text-sm md:text-base hover:bg-white hover:text-indigo-600 transition">
            Đăng nhập
          </button>
        </>
