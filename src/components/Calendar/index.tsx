        ...
        (date: Dayjs) => {
            ...
            const dayReminders = reminders.filter(
                (reminder) =>
                    ...
                    dayjs(reminder.created_at).isSame(date, 'day')
            );
            ...
            return (
                <div className="absolute inset-1 flex flex-col justify-between overflow-hidden">
                    <div className="text-[10px] md:text-sm mt-8 md:mt-0 font-semibold text-gray-600 md:text-left text-right">
                        ...
                        <span className={`ml-2 ${dayReminders.length === 0 ? 'text-gray-400 font-light italic' : 'text-red-500'}`}>
                ...
                >
                    <Tabs defaultActiveKey="tasks">
                                ...
                                renderItem={(task) => (
                                    ...
                                    >
                                        <List.Item.Meta
                                            avatar={
                                                <Avatar
                                                    style={{ backgroundColor: getEventColor(task.status, task.priority) }}
                                                >
                                                    {task.title.charAt(0).toUpperCase()}
                                                </Avatar>
                                            }
                        ...
                        <List
                            ...
                            const task = tasks.find(task => task.id?.toString() === reminder.task_id.toString());
