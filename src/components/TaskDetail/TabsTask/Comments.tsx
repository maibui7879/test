    ...
    return (
        <div className="space-y-6 flex flex-col">
            ...
            {comments && comments.length > 0 ? (
                <List
                    dataSource={comments.slice().reverse()} // đảo ngược mảng
                    className="flex-1"
                    renderItem={(comment) => (
                        <List.Item
                            actions={[
                ...
                <div className="text-center py-4 text-gray-500 flex-1">Chưa có bình luận nào</div>
            )}

            {/* Ô nhập bình luận (Đưa xuống dưới) */}
