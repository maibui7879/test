        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-gray-800">{task.start_time ? dayjs(task.start_time).format('DD/MM/YYYY HH:mm') : '-'}</p>
            )}
          </div>
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-gray-800">{task.end_time ? dayjs(task.end_time).format('DD/MM/YYYY HH:mm') : '-'}</p>
            )}
          </div>
        </div>
        <div>
